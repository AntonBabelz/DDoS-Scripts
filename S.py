...
def helptext ():
        ...
        print "<--------------------------------------------->"
        print "[+]USE V.P.N TO HIDE YOUR IP ADDRESS SO YOU WONT GET DDOS BACK"
        print "<--------------------------------------------->"
        print "[+]  -t [Ammount of attacks]"
        print "[+]  -c [Amount of bots you want to send]"
        print "[+]  -p [Port of server]"
        print "[+]  Version 1"
        print "<--------------------------------------------->"
        print "[+]Coded by ZernSG"
        print "[+]Modified by ZernSG"
        print "[+]Author by Hoon"
        print "[+]GTX Team tools"
        print "[+]Press CTRL+C To stop ddos"
        print "<--------------------------------------------->"
        print "[+]USER : GTX TEAM"
        print "[+]DONT LEAK THIS TOOL"
        print "[+]Auto time out for non anti ddos"
        print "<--------------------------------------------->"
        exit()
...
def sender (num):
        ...
        col()
        print "[+]GTX BOT IS ATTACKING! %d " % num
