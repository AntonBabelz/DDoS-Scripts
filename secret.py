...
def helptext ():
        print "Usage: %s is 1.1 for GNU/Linux - How to ddos? do python2 secret.py (ip target) [-t] [-c] [-p]\n" % sys.argv[0]
        print " Example of launch attack ( python2 secret.py (127.00.00.0) -t 999999 -c 100000 -p 80)"
        print ""
        print ""
        print ""
        print ""
        ...
        print ""
        print ""
        print " <DO NOT LEAK THIS TOOLS OR BLACKLIST"
        print ""
        print ""
        print ""
        print "Secret Team, Termux tool"
        exit()
