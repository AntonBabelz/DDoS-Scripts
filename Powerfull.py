...
def keyword_list():
        ...
        keyword_top.append('Indo')
        keyword_top.append('Kucing')
        keyword_top.append('Killing')
        keyword_top.append('Asade')
...
def buildblock(size):
	...
	for i in range(0, size):
		a = random.randint(65, 1000000000)
		out_str += chr(a)
	return(out_str)
